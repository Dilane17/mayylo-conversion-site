      ...
      <div className="container-main">
        <div className="section-head">
          ...
          <h2 className="h-section">
            Une adresse Gmail vous fait perdre des clients — sans que vous le
            sachiez.
          </h2>
        </div>
          ...
          <div className="ba-card before">
            ...
            <div className="ba-mock">
              <div className="ba-mail">
                <div className="av" style={{ background: "#8A9499" }}>
                  ?
                </div>
                <div>
          ...
          <div className="ba-card after">
            ...
            <div className="ba-mock">
              <div className="ba-mail">
                ...
                <div>
                  <div className="from">Votre entreprise</div>
                  <div className="em">contact@votreentreprise.com</div>
                </div>
              ...
              <div className="ba-mail">
                ...
                <div>
                  <div className="from">Votre commercial</div>
                  <div className="em">commercial@votreentreprise.com</div>
                </div>
