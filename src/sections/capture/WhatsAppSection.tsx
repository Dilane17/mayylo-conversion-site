      ...
      <div className="container-main">
        <div className="cap-wa-band">
          <div className="copy">
            ...
            <p>
              Discutez directement avec notre équipe sur WhatsApp. Une vraie
              personne, en français, prête à répondre à vos questions.
            </p>
          </div>
          <div className="num">
            <a
            ...
            <div className="small">+229 01 90 91 35 89</div>
          </div>
        </div>
      </div>
    </section>
